<html>
    <head>
        <title>T3MPO - Touchless 3D Music Production Overlord</title>    
        <link rel ="stylesheet" type ="text/css" href ="css/bootstrap.css">
        <link rel ="stylesheet" type ="text/css" href ="css/custom.css">
        <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Iceland|Play|Droid+Sans">
        <meta charset="utf-8">
        <link rel="icon" type="image/png" href="images/logo.png">
    </head>
    <body> 
			<nav id = "navigation" class="navbar-static-top" style ="position:fixed;white-space: nowrap;overflow: hidden;" role="navigation" width="100%">
				<div class="navbar-header">
					<a href = "index.php"> <img class = "navbar-brand" src= "images/logo.png" height="75px"></a>
				</div>
				<div class = "title" style="padding-top:20px;">
					<a href="index.php";id="homeLink" style="font-family:'Iceland',serif;font-size:30px;"><strong>T3MPO: </strong>Touchless 3-Dimensional Music Production Overlord</a>
				</div>
			</nav>
